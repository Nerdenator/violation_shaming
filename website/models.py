...
class Violation(models.Model):
    ...
    case_opened = models.DateField(default='')
    case_closed = models.DateField(default='')
    ...
    violation_entry_date = models.DateField(default='')
